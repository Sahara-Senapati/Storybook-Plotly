...
class Card5 extends Component {
    render() {
        ...
        const val1 = text("Value", "+20%");
        const title = text("Title text", "Income");
        ...
        const col1 = color(" Title Text color", "#7e0cf5");
        ...
        return (
            <div class="container center" style={cont}>
                 ...
                 <div class="card" style={card1}>
                    <IconContext.Provider value={{ color: "#7e0cf5",textAlign:"left", size:sizeicon,marginBottom:"20px", }}>
                      <div>
                        <FaArrowAltCircleUp />
                      </div>
