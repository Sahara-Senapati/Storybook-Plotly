...
class Received extends Component {
    render() {
      ...
      const rname = text("Receiver name", "Victoria Vals");
      const val1 = text("Value", "+$634");
      const details = text("Details"," Received 2h ago");
      ...
      const color3 = color("Details Text color", "#aacdbe");
      ...
      const bcolor = color("Background color", "#428a75");   
